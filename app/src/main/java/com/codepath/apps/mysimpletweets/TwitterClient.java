...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "ue7QQDaKqyRibEw0pHHokWDsd";       // Change this
	public static final String REST_CONSUMER_SECRET = "RYCZFSUQ3zqGkgku4Mmsikv5vMpyz5UgmwB4wpRxxWtbBLSf4v"; // Change this
	public static final String REST_CALLBACK_URL = "oauth://cpsimpletwees"; // Change this (here and in manifest)
